...
//                       color: _getCommunityColor(community.id),
...
//                     value: community.membersCount?.toString() ?? '?',
//                     label: 'Membres',
//                   ),
//                   _buildStatItem(
//                     icon: Icons.folder_outlined,
//                     value: community.projectsCount?.toString() ?? '?',
//                     label: 'Projets',
//                   ),
//                   _buildStatItem(
...
//                 const SizedBox(width: 16),
//                 _buildDetailItem('Créée', _formatDate(community.createdAt)),
//               ],
//             ),
//           ],
//         ),
